...
<head>
	<meta charset="utf-8">
	<title>Payment Mode and Mathods | Digital Dezire</title>
	<!-- Stylesheets -->
...
<body>
	...
	<div class="page-wrapper">
		...
		<!-- About Section -->
		<section class="about-section myabout2">
		<div class="container new-container">
				<div class="row">
					<div class="col-xl-12 col-lg-12">
						<div class="blog-details__left">
							<div class="blog-details__content">
								<h3 class="blog-details__title">Refund Policy</h3>
								<p>We always make sure to make our customer Happy but We do not Entertain any subject of Refund So Once you Paid will not Refunded Back, We will only Refund in Some Special Case.</p>

								<p><strong>We Do not have any Refund Policy For Website and Other Services*<.strong></p>

								<p>We have different refund policy for different services. We do not guarantee any refund for cancellation of services, for the transaction charges, for any fund spend on search engines, for service already delivered, for amount already spend on promotional activities like Adwords or any other miscellaneous charges that are non recoverable.</p>
